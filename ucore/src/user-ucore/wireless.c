...
uint8_t power_value[] = {0xe1, 0xa1, 0x81, 0x82, 0x83, 0x84, 0x85, 0x42, 0x22, 0x23, 0x24, 0x25, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d};
...
void set_mode(int mode)
{
	...
	case 1000:
		...
		break;
	default:
		cprintf("error : supported mode : 20, 40, 100, 200, 250, 500, 1000 kbps\n");
		return;
		break;
	}
