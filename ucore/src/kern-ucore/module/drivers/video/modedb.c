...
static const struct fb_videomode modedb[] = {
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 60, 640, 480, 39721, 40, 24, 32, 11,
				      96, 2,
				      0, FB_VMODE_NONINTERLACED}, {
								   ...
								   FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_INTERLACED}, {
				   ...
				   NULL, 85, 640, 400, 31746, 96, 32, 41, 1, 64,
				   3,
							     ...
							     FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 60, 800, 600, 25000, 88, 40, 23, 1,
				      128, 4,
								...
								FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_INTERLACED}, {
				   ...
				   NULL, 72, 800, 600, 20000, 64, 56, 23, 37,
				   120, 6,
							     ...
							     FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 60, 1152, 864, 11123, 208, 64, 16,
				      4, 256, 8,
				      0, FB_VMODE_NONINTERLACED}, {
								   ...
								   FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 87, 1280, 1024, 12500, 56, 16, 128,
				      1, 216, 12,
				      0, FB_VMODE_INTERLACED}, {
								...
								FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 70, 1152, 864, 10869, 106, 56, 20,
				      1, 160, 10,
				      0, FB_VMODE_NONINTERLACED}, {
								   ...
								   FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 75, 1400, 1050, 7190, 120, 56, 23,
				      10, 112, 13,
				      FB_SYNC_HOR_HIGH_ACT |
				      FB_SYNC_VERT_HIGH_ACT,
				      FB_VMODE_NONINTERLACED}, {
								...
								FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 78, 1152, 864, 9090, 228, 88, 32, 0,
				      84, 12,
				      0, FB_VMODE_NONINTERLACED}, {
										 ...
										 FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 100, 1024, 768, 8658, 192, 32, 21,
				      3, 192, 10,
				      0, FB_VMODE_NONINTERLACED}, {
								   ...
								   FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 100, 1152, 864, 7264, 224, 32, 17,
				      2, 128, 19,
				      0, FB_VMODE_NONINTERLACED}, {
										 ...
										 FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 85, 512, 384, 45454, 48, 16, 16, 1,
				      64, 3,
				      0, FB_VMODE_NONINTERLACED}, {
									   ...
									   FB_VMODE_DOUBLE},
	{
	 ...
	 0, FB_VMODE_DOUBLE}, {
			       ...
			       NULL, 60, 1920, 1200, 5177, 128, 336, 1, 38, 208,
			       3,
			       FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
			       FB_VMODE_NONINTERLACED}, {
							 ...
							 FB_VMODE_NONINTERLACED},
	{
	 ...
	 0, FB_VMODE_NONINTERLACED}, {
				      ...
				      NULL, 60, 1280, 800, 12048, 200, 64, 24,
				      1, 136, 3,
				      0, FB_VMODE_NONINTERLACED},
};
		       ...
		       const struct fb_videomode *mode, unsigned int bpp)
{
	...
	DPRINTK("Trying mode %s %dx%d-%d@%d\n",
		mode->name ? mode->name : "noname", mode->xres, mode->yres, bpp,
		mode->refresh);
	var->xres = mode->xres;
	var->yres = mode->yres;
		 ...
		 unsigned int default_bpp)
{
	...
	if (mode_option) {
		...
		int yres_specified = 0, cvt = 0, rb = 0, interlace =
		    0, margins = 0;
		u32 best, diff, tdiff;
		     ...
		     const struct fb_videomode *mode2)
{
	return (mode1->xres == mode2->xres &&
		...
		mode1->sync == mode2->sync && mode1->vmode == mode2->vmode);
}
