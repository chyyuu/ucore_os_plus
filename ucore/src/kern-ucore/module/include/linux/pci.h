...
static inline struct pci_cap_saved_state *pci_find_saved_cap(struct pci_dev
							     *pci_dev, char cap)
{
...
static inline struct pci_bus *__devinit pci_scan_bus(int bus,
						     struct pci_ops *ops,
						     void *sysdata)
{
...
int __must_check pci_request_region_exclusive(struct pci_dev *, int,
					      const char *);
