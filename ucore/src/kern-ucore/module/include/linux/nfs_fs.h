 ...
 */
static inline int nfs_verify_change_attribute(struct inode *dir,
 ...
 * return value!)
 */
extern long nfs_sync_mapping_wait(struct address_space *,
				  struct writeback_control *, int);
