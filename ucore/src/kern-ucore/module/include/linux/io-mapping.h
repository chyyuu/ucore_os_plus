...
/* Atomic map/unmap */
static inline void *io_mapping_map_atomic_wc(struct io_mapping *mapping,
...
static inline void *io_mapping_map_wc(struct io_mapping *mapping,
				      unsigned long offset)
{
	resource_size_t phys_addr;
...
static inline void io_mapping_unmap(void *vaddr)
{
	iounmap(vaddr);
}
