...
extern const struct zorro_device_id *zorro_match_device(const struct
							zorro_device_id *ids, const struct zorro_dev
							*z);
...
extern struct zorro_dev *zorro_find_device(zorro_id id, struct zorro_dev *from);
