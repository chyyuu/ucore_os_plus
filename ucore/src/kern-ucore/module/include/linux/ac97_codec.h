...
struct ac97_codec {
	...
	int (*mixer_ioctl) (struct ac97_codec * codec, unsigned int cmd,
			    unsigned long arg);
	...
	int (*modem_ioctl) (struct ac97_codec * codec, unsigned int cmd,
			    unsigned long arg);
};
...
struct ac97_ops {
	...
	int (*digital) (struct ac97_codec * codec, int slots, int rate,
			int mode);
