...
static inline struct gameport *gameport_allocate_port(void)
{
	struct gameport *gameport =
	    kzalloc(sizeof(struct gameport), GFP_KERNEL);
...
static inline int __must_check gameport_register_driver(struct gameport_driver
							*drv)
{
...
static inline void gameport_set_poll_handler(struct gameport *gameport,
					     void (*handler) (struct gameport
							      *))
{
