...
extern int addrconf_add_ifaddr(struct net *net, void __user * arg);
extern int addrconf_del_ifaddr(struct net *net, void __user * arg);
extern int addrconf_set_dstaddr(struct net *net, void __user * arg);
...
extern int ipv6_chk_home_addr(struct net *net, struct in6_addr *addr);
#endif
...
extern void addrconf_join_solict(struct net_device *dev, struct in6_addr *addr);
extern void addrconf_leave_solict(struct inet6_dev *idev,
				  struct in6_addr *addr);

static inline unsigned long addrconf_timeout_fixup(u32 timeout, unsigned unit)
{
...
extern int __ipv6_dev_mc_dec(struct inet6_dev *idev,
			     const struct in6_addr *addr);
 ...
 */
extern int ipv6_sock_ac_join(struct sock *sk, int ifindex,
			     struct in6_addr *addr);
extern int ipv6_sock_ac_drop(struct sock *sk, int ifindex,
			     struct in6_addr *addr);
...
static inline struct inet6_dev *in6_dev_get(struct net_device *dev)
{
					     ...
					     struct in6_addr *solicited)
{
	ipv6_addr_set(solicited,
		      htonl(0xFF020000), 0,
		      htonl(0x1), htonl(0xFF000000) | addr->s6_addr32[3]);
}
