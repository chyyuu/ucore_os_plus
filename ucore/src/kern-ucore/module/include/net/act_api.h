...
struct tc_action_ops {
	...
	int (*init) (struct nlattr *, struct nlattr *, struct tc_action *, int,
		     int);
...
extern struct tc_action *tcf_action_init(struct nlattr *nla, struct nlattr *est,
					 char *n, int ovr, int bind);
extern struct tc_action *tcf_action_init_1(struct nlattr *nla,
