 ...
 */
static inline char *iwe_stream_add_event(struct iw_request_info *info,
					 char *stream, char *ends,
 ...
 * stream of events.
 */
static inline char *iwe_stream_add_point(struct iw_request_info *info,
					 char *stream, char *ends,
 ...
 */
static inline char *iwe_stream_add_value(struct iw_request_info *info,
					 char *event, char *value, char *ends,
					 struct iw_event *iwe, int event_len)
{
	int lcp_len = iwe_stream_lcp_len(info);
