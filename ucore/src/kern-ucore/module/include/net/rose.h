...
extern int rose_rx_call_request(struct sk_buff *, struct net_device *,
...
extern void rose_link_rx_restart(struct sk_buff *, struct rose_neigh *,
				 unsigned short);
extern void rose_transmit_clear_request(struct rose_neigh *, unsigned int,
...
extern struct rose_route *rose_route_free_lci(unsigned int,
					      struct rose_neigh *);
...
extern int rose_parse_facilities(unsigned char *,
