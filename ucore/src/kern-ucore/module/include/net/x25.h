...
extern int x25_rx_call_request(struct sk_buff *, struct x25_neigh *,
			       unsigned int);
...
/* x25_link.c */
extern void x25_link_control(struct sk_buff *, struct x25_neigh *,
			     unsigned short);
...
extern void x25_transmit_clear_request(struct x25_neigh *, unsigned int,
				       unsigned char);
